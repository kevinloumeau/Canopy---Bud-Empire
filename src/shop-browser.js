...
export function mountShopBrowser({getState,components,kiosks,queueLimit,recommend}) {
  ...
  const definitions=[['upgradeStorage',0],['boost',0],['buyKiosk',1],['buyAutoDrone',1],['componentBuy1',1],['componentBuy2',1],['componentBuy5',1],['componentBuy8',1],['componentBuy9',1],['upgradeQueue',2],['componentBuy0',2],['componentBuy7',2],['componentBuy3',3],['componentBuy4',3],['componentBuy6',3]];
  ...
  function render(){
    ...
    empty.textContent='All upgrades in this category are complete.';
