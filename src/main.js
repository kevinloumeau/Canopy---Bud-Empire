(function () {
  ...
  function selectMachine(i){selected=i;machineTabs.forEach(function(tab,index){tab.setAttribute('aria-pressed',String(index===i))});renderUI();if(navigator.vibrate)navigator.vibrate(8)}
